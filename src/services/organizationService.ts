...
import { FoundAdministration } from "../generated/onboarding/FoundAdministration";
...
export async function findAllNotPreDraft(
  ...
  const publicAdministrations: ReadonlyArray<IpaPublicAdministrationModel> = await sequelize.query(
    `
      SELECT *
