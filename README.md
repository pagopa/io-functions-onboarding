...
Le api del portale di onboarding per l'app [IO](https://io.italia.it) attraverso il quale le pubbliche amministrazioni possono registrarsi.
...
- settare le variabili d'ambiente come nel file [env.example](./env.example)
- eseguire `yarn dev`
